...
<head>
    ...
    <link rel="stylesheet" href="{{asset('./assetsClient/css/font/font.css')}}">
    <link rel="stylesheet" href="{{asset('./assetsClient/css/responsive.css')}}" media="(max-width:991px)">
</head>
<body>
...
<script src="{{asset('assetsClient/js/jquery-3.4.1.min.js')}}"></script>
<script src="{{asset('assetsClient/js/js.js')}}"></script>
<script src="{{asset('assetsClient/js/countDownTimer.js')}}"></script>
</body>
</html>
